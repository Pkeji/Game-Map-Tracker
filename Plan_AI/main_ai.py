...
def run_minimap_setup_or_exit() -> None:
    """Use the shared Qt calibrator so the AI reference entry no longer depends on the old Tk selector chain."""
    print(">>> 正在启动小地图选择器...")
